    ...
    <div class="col-md-6">
       ...
       <div class="col-md-6">
		...
		<label class="control-label text-left col-xs-12 col-sm-5 no-padding-right" for="text">Type of Vehicle</label>
            <div class="col-xs-12 col-sm-7">
			<div class="clearfix">
			   <select class="col-xs-12 col-sm-6 form-control" name="typeOfVehicle" onchange="getModel(this)" id="typeofvehical">
	 <option value="0">Select Type of Vehicle</option>
							<c:forEach items="${list1}" var="vehicle">
...
<div class="col-md-6">
    ...
    <input class="form-control date-picker" type="text" name="permit" data-date-format="dd-mm-yyyy" value="${csd.permit}" />
	  ...
	  <div class="col-md-6">
      <div class="form-group">
         <label class="control-label text-left col-xs-12 col-sm-5 no-padding-right" for="text">Tax Validity Lifetime?</label>
        <div class="col-xs-12 col-sm-7">
       <input type="checkbox"  name="checkboxvalue" id="taxyes" value="0" onclick="csd3();"  > yes
       <input type="checkbox" id="taxno" name="checkboxvalue" value="0" onclick="csd2();" > no
        </div>
		</div>
		</div>
		
		<br>
        <div class="col-md-6" style="display:none" id="taxdiv">
      <div class="form-group">
         <label class="control-label text-left col-xs-12 col-sm-5 no-padding-right" for="text">Tax</label>
       <div class="col-xs-12 col-sm-7">
      <div class="input-group">
    <input class="form-control date-picker"  type="text" name="otherStateTax" data-date-format="dd-mm-yyyy" value="${csd.otherStateTax}" id="otherstate"/>
																	<span class="input-group-addon">
																		<i class="fa fa-calendar bigger-110"></i>
																	</span>
																</div>
...
<div class="col-md-6" style="line-height:38px;">
      <div class="form-group">
       <label class="control-label text-left col-xs-12 col-sm-5 no-padding-right" for="text">Registration Certificate
	</label> 
	 <div class="col-xs-12 col-sm-7"><input type="file" name="rcfileData" >
	
	</div> 
	<div class="col-xs-12 col-sm-6">
          <a href='downloadDocument?Id=${csd.vehicleId}&fileName=${csd.rcfileName}' target="_blank">${csd.rcfileName}</a>
          <input type="hidden" name="rcfileName" value="${csd.rcfileName}" >
          </div>
      </div>
    </div>
...
<div class="col-md-6" style="line-height:38px;">
      <div class="form-group">
      <label class="control-label text-left col-xs-12 col-sm-5 no-padding-right" for="text">PUC Certificate 
	</label> 
	<div class="col-xs-12 col-sm-7"><input type="file" name="pucfileData">
	</div> 
     <div class="col-xs-12 col-sm-6">
          <a href='downloadDocument?Id=${csd.vehicleId}&fileName=${csd.pucfileName}' target="_blank">${csd.pucfileName}</a>
           <input type="hidden" name="pucfileName" value="${csd.pucfileName}" >
          </div>    
      </div>
    </div>
<div class="col-md-6" style="line-height:38px;">
      <div class="form-group">
       <label class="control-label text-left col-xs-12 col-sm-5 no-padding-right" for="text">Vehicle Photograph
	</label> 
	<div class="col-xs-12 col-sm-7"><input type="file" name="fileData">
	</div> 
      <div class="col-xs-12 col-sm-6">
          <a href='downloadDocument?Id=${csd.vehicleId}&fileName=${csd.fileName}' target="_blank">${csd.fileName}</a>
          <input type="hidden" name="fileName" value="${csd.fileName}" >
          </div>   
      </div>
    </div>
	  ...
	  <div class="col-md-6">
      <div class="form-group">
       <label class="control-label text-left col-xs-12 col-sm-5 no-padding-right" for="text">on finance?</label>
    <div class="col-xs-12 col-sm-7">
       <input type="checkbox" id="installment" name="checkboxvalue" value="0" onclick="csd1();" >
  ...
  <div class="main_box section_one panel panel-primary" id="installmentdetails" style="display:none">
   ...
   <div class="panel-heading">
    ...
    <div class="col-xs-12 col-sm-7">
          <input type="text" class="form-control" name="bankName" value="${csd.bankName}">
        </div>
    ...
    <div class="col-xs-12 col-sm-7">
          <input type="text" class="form-control" name="accountNo" value="${csd.accountNo}" id="inn">
        </div>
    ...
    <div class="col-xs-12 col-sm-7">
          <input type="text" class="form-control" name="downPayment" value="${csd.downPayment}">
        </div>
    ...
    <div class="col-xs-12 col-sm-7">
          <input type="text" class="form-control" name="installmentPayment" value="${csd.installmentPayment}">
        </div>
    ...
    <div class="col-xs-12 col-sm-7">
          <input type="text" class="form-control" name="noOfMonths" value="${csd.noOfMonths}">
        </div>
    ...
    <input type="file" name="bankfileData" >
     ...
     <div class="col-xs-12 col-sm-6">
          <a href='downloadDocument?Id=${csd.vehicleId}&fileName=${csd.bankfileName}' target="_blank">${csd.bankfileName}</a>
           <input type="hidden" name="bankfileName" value="${csd.bankfileName}" >
          </div>        
      </div>
    </div>
    <div class="col-md-6">
    ...
    <input type="file" name="additionalfileData" >
      ...
      <div class="col-xs-12 col-sm-6">
          <a href='downloadDocument?Id=${csd.vehicleId}&fileName=${csd.additionalfileName}' target="_blank">${csd.additionalfileName}</a>
           <input type="hidden" name="addfileName" value="${csd.additionalfileName}" >
          </div>       
      </div>
    </div>
