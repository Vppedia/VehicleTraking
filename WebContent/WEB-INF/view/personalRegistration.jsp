   ...
   <form  id="csd">
    ...
    <div class="panel-body">
		...
		<label class="control-label text-left col-xs-12 col-sm-5 no-padding-right" for="text">Company Name</label>
         ...
         <div class="row">
      <div class="  border">
        <div class="col-sm-3"><p>Type of Vehicle</p></div>
        <div class="col-sm-3 inpur_box">
         <select name="typeOfVehicle" onchange="getModel()">
	 ...
	 <option value="Bus">Bus</option>
            ...
            <div class="row">
      <div class="  border">
        <div class="col-sm-3"><p>Owner Name</p></div>
        <div class="col-sm-3 inpur_box">
	 ...
	 <div class="row">
      <div class="  border">
       <div class="col-sm-3"><p>Date of Purchase</p></div>
       <div class="col-sm-3 inpur_box">
		 <input type="text" class="form-control" name="dateOfPurchase" >
	...
	<div class="row">
      <div class="  border">
       <div class="col-sm-3"><p>Chachis Number</p></div>
       <div class="col-sm-3 inpur_box">
	...
	<div class="row">
      <div class="  border">
       <div class="col-sm-3"><p>Engine Number</p></div>
       <div class="col-sm-3 inpur_box">
	...
	<div class="row">
      <div class="  border">
       <div class="col-sm-3"><p>Key Number</p></div>
       <div class="col-sm-3 inpur_box">
	...
	<div class="row">
      <div class="  border">
       <div class="col-sm-3"><p>Fitness</p></div>
       <div class="col-sm-3 inpur_box">
		 <input type="text" class="form-control" name="fitness" >
	...
	<div class="row">
      <div class="  border">
       <div class="col-sm-3"><p>Permit</p></div>
       <div class="col-sm-3 inpur_box">
		 <input type="text" class="form-control" name="permit" >
        ...
        <div class="row">
      <div class="  border">
        <div class="col-sm-3"><p>Other State Tax</p></div>
        <div class="col-sm-3 inpur_box">
       <input type="text" class="form-control" name="otherStateTax" >
...
<div class="row">
      <div class="  border">
       <div class="col-sm-3 tsize">Registration Certificate
	</div> 
	<div class="col-sm-3 tsize"><input type="file" >
	</div> 
...
<div class="row">
      <div class="  border">
       <div class="col-sm-3 tsize">PUC Certificate 
	</div> 
	<div class="col-sm-3 tsize"><input type="file" >
	</div> 
...
<div class="row">
      <div class="  border">
       <div class="col-sm-3 tsize">Vehicle Photograph
	</div> 
	<div class="col-sm-3 tsize"><input type="file" >
	</div> 
  ...
  <div class="main_box section_one panel panel-primary" id="installmentdetails" style="display:none">
   ...
   <div class="panel-heading">
    ...
    <div class="panel-body">
      ...
      <div class="  border">
        <div class="col-sm-3"><p>Bank Name</p></div>
        <div class="col-sm-3 inpur_box">
        ...
        <div class="row">
      <div class="  border">
        <div class="col-sm-3"><p>Down Payment</p></div>
         <div class="col-sm-3 inpur_box">
	 ...
	 <div class="row">
      <div class="  border">
        <div class="col-sm-3"><p>Installment Amount</p></div>
         <div class="col-sm-3 inpur_box">
	 ...
	 <div class="row">
      <div class="  border">
        <div class="col-sm-3"><p>Number of Months</p></div>
         <div class="col-sm-3 inpur_box">
	   ...
	   <div class="row">
      <div class="  border">
        <div class="col-sm-3 tsize">Bank Documents
	</div> 
	<div class="col-sm-3 tsize"><input type="file" >
	</div> 
	 ...
	 <div class="row">
      <div class="  border">
       <div class="col-sm-3 tsize">Additional Files
	</div> 
	<div class="col-sm-3 tsize"><input type="file" >
	</div> 
 ...
 <input type="button" value="submit" onclick="csd()"/>
 </form>
...
<div id="internships1"> </div>
	  ...
	  <div class="col-sm-offset-9 col-sm-3 text-center"> 
        ...
        <button class="btn btn-primary" id="remove-panel">Remove Role</button>  
		</div>
...
border-radius: 5px;
  ...
  <div class="container">
   ...
   <input type="hidden" name="personalCommercial" value="Personal">
      <div class="main_box section_one panel panel-primary">
     <div class="panel-heading">
           Registration
        </div>
