					...
					<c:forEach items="${model}" var="approval" varStatus="loop">
						<tr>
							...
							<td><form id="approve${approval.vehicleId}" method="post">
						           		...
						           		<input type="button" value="delete" class="btn btn-primary" onclick="remove(${approval.vehicleId})"/>
	                              </td>
						</tr>
					</c:forEach>
				</tbody>
...
function edit(vehicleId){
    ...
    document.getElementById("approve"+vehicleId).action="editCommercialVehicleDetails";	
